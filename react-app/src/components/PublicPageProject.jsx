...
const PublicPageProject = () => {
  ...
  return (
    <Dialog open={open} onClose={handleClose} fullWidth>
      ...
      <DialogContent>
        Description:
        <div style={{ marginLeft: "2em" }}>{project?.description}</div>
      </DialogContent>

      <DialogContent>
        Created at:
        <div style={{ marginLeft: "2em" }}>{project?.created_at}</div>
      </DialogContent>
      <DialogContent>
        Languages used:
        <div style={{ marginLeft: "2em" }}>
          {project?.github
            ? languagePercentages(project.languages)
            : plainLanguageList(project.languages)}
        </div>
      </DialogContent>
    </Dialog>
  );
